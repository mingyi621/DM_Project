...
w = open('sortByStopTimeData.csv','w')
...
def stringToTimeStamp(t): # time = '2017-04-01 00:01:54'
	...
	if month == 4:
		...
		timeStamp = second + minute * 60 + hour * 3600 + day * 86400 + (30 + 31 + 30) * 86400
		print t
	else:
		print t
...
for station in stationList:
	...
	for element in allData:
		if station[0] == element[7]:
			oneStationData.append(element)
	temp = sorted(oneStationData, key=lambda x: stringToTimeStamp(x[2]))
	oneStationData = temp
